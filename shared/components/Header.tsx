                ...
                {openUserMenu && (
                  ...
                  >
                    <div className="p-2">
                      <Link href="/profile">
                        <span
                          className="block rounded-lg px-4 py-2 text-sm text-zinc-700 hover:bg-zinc-50 dark:text-zinc-200 dark:hover:bg-zinc-900/60"
                          role="menuitem"
                        >
                          Mon profil
                        </span>
              ...
              <div className="mt-2 border-t border-zinc-100 pt-2 dark:border-zinc-800">
                ...
                <div className="mt-3 space-y-1 px-1">
                  {user?.email ? (
                    ...
                    <Link href="/login">
                      <span className="block rounded-lg px-3 py-2 text-sm text-zinc-700 hover:bg-zinc-50">
                        Se connecter
                      </span>
                    </Link>
                  )}
