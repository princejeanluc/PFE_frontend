...
import { BGSection } from "@/features/marketing/data/section";
      ...
      >
        <motion.div
          ...
          className={clsx(
            ...
            light ? "bg-white/55 border-white/40 text-zinc-900" : "bg-black/45 border-white/10 text-white",
            "max-w-xl"
          )}
        >
            ...
            {s.features.map((f, i) => (
              <motion.span
                ...
                className={clsx(
                  ...
                  light ? "bg-white/70 border-white/60" : "bg-white/10 border-white/20"
                )}
              >
                {f}
              </motion.span>
          ...
          {s.href && (
            <motion.div variants={chipVariants} className="mt-5">
              <Link
                href={s.href}
                className={clsx("inline-block px-4 py-2 rounded-lg text-sm font-medium", light ? "bg-black text-white" : "bg-white text-black")}
              >
                Ouvrir
              </Link>
            </motion.div>
