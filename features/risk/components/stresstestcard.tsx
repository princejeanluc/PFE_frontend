...
import { usePortfolios } from "@/features/simulation/hooks/simulation";
import { useApplyStress, useStressScenarios } from "@/features/risk/hooks/risk";
      ...
      <CardHeader className="flex flex-row items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-2">
          {loadingPfs ? (
            ...
            <Select value={portfolioId ? String(portfolioId) : undefined} onValueChange={(v) => setPortfolioId(Number(v))}>
                  ...
                  return (
                    <div key={sc.id} className="grid grid-cols-[1fr,180px,120px] items-center py-2">
                      ...
                      <div className="text-right pr-2">
                        <Button size="sm" variant="secondary" disabled={!portfolioId || isBusy} onClick={() => handleSimulate(sc.id)}>
