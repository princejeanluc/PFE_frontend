...
import { useDeletePortfolio, useSimulatePortfolio } from "@/features/simulation/hooks/simulation";
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              ...
              <AlertDialogFooter>
                ...
                <AlertDialogAction onClick={() => del.mutate(portfolio.id, { onSuccess: () => onDeleted?.() })}>
                  Supprimer
                </AlertDialogAction>
              </AlertDialogFooter>
            </AlertDialogContent>
